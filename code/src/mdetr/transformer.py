...
from transformers import AutoModel, RobertaModel, RobertaConfig
...
class Transformer(nn.Module):
    def __init__(
        ...
        self.tokenizer = None  # RobertaTokenizerFast.from_pretrained(text_encoder_type)
        config = RobertaConfig.from_pretrained(text_encoder_type)
        self.text_encoder: RobertaModel = AutoModel.from_config(config)
